...
function placeXOrO(squareNumber) {
    //This conditions ensures a square hasn't been selected already.
    ...
    if(!selectedSquares.some(element =>element.includes(squareNumber))) {
        ...
        //SqareNumber and activePlayer are concatenated together and added to array
        ...
        //Returing true is needed for our computersTurn() function to work
        return true;

    }

    //This function parses the selectedSquares array to searc for win conditions.
    //Drawline() function is called to draw a line on th screen if the condition is met
    function checkWinConditions() {
        //X 0, 1, 2 condition
        if(arrayIncludes('1X', '1X', '2X')){drawWinLine(50, 100, 558, 100)}
        //X 3, 4, 5 condition
        ...
        //This condition checks for a tie. If none of the above conditions are met and 9 square are selected the code executes
        ...
        function arrayIncludes(squareA, squareB, squareC) {
            ...
            //If the 3 variables we pass are all included in our array then true is returned and our else if condition executes
     ...
     //This function utilices HTML canvas to draw win lines
     function drawWinLine(coordX1, coordY1, coordX2, coordY2)  {
        ...
        let x1 = coordX1,
            // This line indicates where that start of a line y axis is
            y1 = coordY1,
    ...
    function computersTurn() {
        ...
        while(!success) {
            ...
            //if he random number evaluated returns true, the square hasn't been selected yet
